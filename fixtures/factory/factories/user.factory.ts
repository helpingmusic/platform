...
export function registerUserFactory(User, factory) {
  ...
  const defaultUser = {
    ...
    membership_types: factory.chance('pickset', [MembershipType.PLAYER, MembershipType.PRODUCER, MembershipType.PATRON, MembershipType.PERFORMER, MembershipType.PUBLISHER]),
